	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(WorkspaceInformation, { name: 'Alive', price: this.props.price, duration: '1' }),
	...
	render: function render() {
		...
		if (this.state.mounted) {
			...
			container = React.createElement(
				Container,
				null,
				React.createElement(ImagePreview, { price: this.state.price, duration: this.state.duration, people: this.state.people, image: '../Album/BBB.jpeg' }),
