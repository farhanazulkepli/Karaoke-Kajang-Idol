	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(WorkspaceInformation, { name: 'The Most Beautiful Moment In Life: Young Forever    ', price: this.props.price, duration: '1' }),
...
var App = React.createClass({
	...
	render: function render() {
		...
		if (this.state.mounted) {
			overlay = React.createElement(Overlay, { image: '../Album/HBTS.jpg' });
			container = React.createElement(
				Container,
				null,
				React.createElement(ImagePreview, { price: this.state.price, duration: this.state.duration, people: this.state.people, image: '../Album/BTSC.jpeg' }),
